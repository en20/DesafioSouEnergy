    ...
    <DashboardLayout title="Dashboard do Cliente">
      <div className="bg-white shadow-md rounded-lg p-6 border border-gray-100">
        ...
        <div className="relative">
          ...
          <div className="bg-gradient-to-r from-[#3163CF]/10 to-[#ED8130]/10 p-8 rounded-md border border-gray-100 text-center">
            <div className="mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-[#3163CF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button className="mt-6 px-5 py-2 bg-[#3163CF] text-white rounded-md hover:bg-blue-700 transition duration-150 font-medium shadow-sm">
              Verificar Conta
            </button>
          </div>
        </div>
