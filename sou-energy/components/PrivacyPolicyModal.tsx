...
export default function PrivacyPolicyModal() {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 transition-transform duration-500 ease-in-out transform ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
      <div className="max-w-5xl mx-auto mt-2 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
        <div className="p-4 flex items-start">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              <h3 className="text-lg font-semibold text-[#E74432]">Política de Privacidade</h3>
              <button
            ...
            <div className="mt-4 flex justify-end space-x-3">
              <button
                ...
                className="px-3 py-1.5 text-sm border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 font-medium transition-all duration-200"
              >
                Rejeitar
              </button>
              <button
                ...
                disabled={loading}
                className="px-3 py-1.5 text-sm bg-[#3163CF] text-white rounded-md hover:bg-blue-700 disabled:opacity-50 font-medium shadow-sm hover:shadow-md transition-all duration-200"
              >
                {loading ? (
